export const siteContent = {
    ...
    projects: [
      {
        id: "snews",
        year: "2026",
        category: "Ecossistema Broadcast & NRCS",
        livePreview: "VER CASE",
        name: "SNEWS Broadcast 2.0",
        description: "Ecossistema completo de software para jornalismo, automação de estúdio, NRCS, playout e transmissão para emissoras de TV e Rádio.",
      ...
      },
      {
        id: "volk",
        year: "2026",
        category: "Interatividade & Broadcast",
        livePreview: "LIVE PREVIEW",
        name: "VOLK Presenter",
        description: "Plataforma de gráficos em tempo real, telas touchscreen e automação para operações de jornalismo, esportes e entretenimento.",
        buttonText: "Ver Projeto",
      ...
      },
      {
        id: "capi",
        year: "2026",
        category: "Cérebro Editorial & IA",
        livePreview: "LIVE PREVIEW",
        name: "CAPI Digital",
        description: "Cérebro operacional para centralizar, organizar e automatizar todo o fluxo de planejamento, produção e publicação de conteúdo multi-canal.",
        buttonText: "Ver Projeto",
  ...
  brands: {
    title: "MARCAS E TIMES COM OS QUAIS JÁ TRABALHEI.",
  },
  ...
  pricing: {
    ...
    toggle: { monthly: "Mensal", annually: "Anual" },
    plans: [
      {
        name: "Essencial",
        description: "Ideal para presença digital inicial e landing pages",
        monthlyPrice: 600,
        annuallyPrice: 900,
        buttonText: "Começar",
        features: [
      ...
      {
        name: "Profissional",
        description: "Para negócios que querem crescer online de verdade",
        monthlyPrice: 1699,
        annuallyPrice: 2199,
        buttonText: "Começar",
        features: [
          "2 projetos simultâneos",
          "E-commerce ou sistema web",
          "Integrações e automações",
          "Suporte via WhatsApp",
          "Canal prioritário no Slack",
        ],
        highlighted: true,
        color: "black",
      },
      {
        name: "Scale",
        description: "Parceria estratégica completa, do design ao deploy",
        monthlyPrice: 2999,
        annuallyPrice: 3999,
        buttonText: "Começar",
        features: [
  ...
  blog: {
    ...
    posts: [
      {
        date: "Jun 10, 2024",
        title: "Por que seu site não converte — e como resolver isso",
        excerpt: "Design bonito não vende. Entenda os 5 erros estruturais que matam a conversão de qualquer site.",
      ...
      {
        date: "Mar 05, 2024",
        title: "Core Web Vitals: o guia prático para sites que rankeiam",
        excerpt: "SEO técnico sem enrolação. Como otimizei um site de 42 pontos para 97 no PageSpeed em 2 semanas.",
  ...
  footer: {
    ...
    links: {
      pages: ["Início", "Sobre", "Portfólio", "Serviços", "Contato"],
      single: ["Landing Pages", "Sites & Apps", "E-commerce", "Integrações"],
      utility: ["FAQ", "Depoimentos", "Planos", "Blog", "Política de Privacidade"],
    },
    social: ["Instagram", "LinkedIn", "WhatsApp", "GitHub"],
  },
};
